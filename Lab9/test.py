...
while run:
    ...
    if left_click and mouse[1] > 70:
        if drawing_mode == 'circle':
            ...
            start_pos = (mouse[0] - active_size, mouse[1] - active_size)
            end_pos = (mouse[0] + active_size, mouse[1] + active_size)
            painting.append(('rectangle', active_color, pygame.Rect(start_pos, (active_size * 2, active_size * 2))))
